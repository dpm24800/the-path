...
```sql
-- 2. Calculate Total Purchase Amount of All Orders: 17541.180145263672
...
```sql
-- 3. Calculate Average Purchase Amount of All Orders: 1461.765012105306
...
```sql
-- 6. Find Minimum Purchase Amount: 65.26
